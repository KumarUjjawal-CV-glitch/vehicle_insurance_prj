...
MIN_SAMPLES_SPLIT_CRITERTION: str = 'entropy'
MIN_SAMPLES_SPLIT_RANDOM_STATE: int = 101 #Ranodm state

"""
MODEL Evaluation related constants
"""
MODEL_EVALUATION_CHANGED_THRESHOLD_SCORE: float = 0.02
MODEL_BUCKET_NAME = "my-first-model-mlopsproj-vehicle-insurance"
