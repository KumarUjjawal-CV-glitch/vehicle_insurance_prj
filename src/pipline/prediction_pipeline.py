...
class VehicleData:
    ...
    def get_vehicle_data_as_dict(self):
        ...
        """
        logging.info("Entered get_usvisa_data_as_dict method as vehicle Data class")
        ...
        try: 
            input_data = {
                ...
                "Vehicle_Age_gt_2_Year": [self.Vehicle_Age_gt_2_Years],
                "Vehicle_Damage_Yes": [self.Vehicle_Damage_Yes]
            }

            logging.info("Created vehicle data dict")
            logging.info("Exited get_vehicle_data_as_dict method as Vehicle class")
            return input_data
