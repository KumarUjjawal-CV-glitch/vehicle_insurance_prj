...
class SimpleStorageService:
    ...
    def __init__(self):
        """
        Initializes the SimpleStorageService instnce with S3 resource and client
    ...
    def read_object(object_name: str, decode:bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        ...
        Args:
            ...
            decode (bool): Whether to convert content to StringIO for DataFrame usage.

        Returns:
        Union[StringIo, str]: The content of the object, as a StringIO or decode string
        """
        ...
        try:
            ...
            logging.info("Exited the read_object method of SimplrStorageService class")
            return conv_func()
        except Exception as e:
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[List[object], object]:
        ...
        try:
            bucket = self.get_bucket(bucket_name)
            file_objects = [file_object for file_object in bucket.objects.filer(Prefix=filename)]
    ...
    def create_folder(self, folder_name: str, bucket_name:str) -> None:
        ...
        try:
            ...
            logging.info("Exiter the create_folder method of SimpleStorageService class")
    
    def upload_file(self, from_filename: str, to_filename: str, bucket_name: str, remove: bool = True):
        """
        Uploads a local file to specified S2 bucket with an optional file deletion
    ...
    def upload_df_as_csv(self, data_frame: DataFrame,local_filename:str, bucket_filename:str, bucket_name:str, remove: bool = True):
        """
        ...
        try:
            # Save DataFrae to CSV locally and then upload it
            data_frame.to_csv(local_filename, index=None, header=True)
            self.upload_file(local_filename,bucket_filename,bucket_name)
            logging.info("Exited the upload_df_as_csv mehod of SimpleStorageService class")
        except Exception as e:
            raise MyException(e, sys) from e
    
    def get_df_from_object(self, object_:object) -> DataFrame:
        """
        Converts an S3 object to DataFrame
        ...
        """
        logging.info("Enterd the get_df_from_object method of SimpleStorageService class")
        try:
