...
class DataTransformation:
    ...
    def get_data_transformer_object(self)-> Pipeline:
        """
        Creates and returns a data transformer object for thr data,
        including gender mapping, dummy variable creation, column renaming,
        feature scaling, and type adjustments
        """
        logging.info("Entered get_data_transformer_objec method of DataTransformation class")
        try:
            ...
            #wrapping everything in a single pipelinr
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try: 
            ...
            #Apply custom transformantions in specified sequence
