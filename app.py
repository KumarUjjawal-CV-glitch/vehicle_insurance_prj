...
from src.pipline.training_pipeline import TranPipeline
...
class DataForm:
    """
    DataForm class to handle and process incoming from data.
    ...
    async def get_vehicle_data(self):
        ...
        self.Vehicle_Damage_Yes = form.get("Vehicel_Damage_Yes")
    
#Toute to render the main page with the form
...
async def trainRouteClient():
    ...
    """
    try:
        train_pipeline = TranPipeline()
        train_pipeline.run_pipeline()
        return Response("!!Training successful!!")
    except Exception as e:
        return Response(f"Error Occured! {e}")

#Route to handle form submission and make predicitons
@app.post("/")
